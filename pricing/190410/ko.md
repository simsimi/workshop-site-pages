...
결제 주기는 프로젝트가 활성화된 날부터 시작되며 사용자가 선택한 구독 상품의 주기에 따라서 자동으로 결제됩니다. 그 후 사용자가 선택한 플랜에 따라 자동으로 월간 혹은 연간으로 결제가 이루어질 것입니다. [SWS console](https://workshop.simsimi.com/dashboard)을 이용해 사용 중인 플랜을 모니터하거나 업그레이드 하십시오.
